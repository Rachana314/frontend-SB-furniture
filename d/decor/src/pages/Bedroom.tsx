...
export default function Bedroom() {
  ...
  const productsPerPage = 4; // ✅ How many per page
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      ...
      <div className="bg-gray-100 flex flex-col md:flex-row items-center md:items-start justify-between p-6 gap-6 mb-6 rounded">
        <h2 className="text-3xl font-extrabold text-blue-900 flex-1 text-center md:text-left">
          ...
          >
            ...
            <div className={viewGrid ? "" : "w-1/3 relative"}>
              ...
              <div
                ...
                className="absolute inset-0 bg-gray-500 bg-opacity-10 flex items-center justify-center opacity-0 group-hover:opacity-50 transition-opacity cursor-pointer text-black text-sm gap-2"
              >
                <FaEye />
                Quick View
              </div>
            ...
            >
              ...
              <div className="mt-2 flex gap-3 group-hover t">
                <button
